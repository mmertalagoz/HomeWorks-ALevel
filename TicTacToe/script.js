...
function chooseArea(block){
    if(block.textContent===''){
        ...
        errorText.textContent = 'This box is a Busy !';
...
function controlTie(){
    ...
    // здесь мы создаем массив и по индексам дивов пушим в массив и если массив уже забит то ничья..
    if(!values.includes('')){
        playerText.textContent = 'No Win' 
        blocks.forEach(block=>block.style.pointerEvents='none')
    }
}
